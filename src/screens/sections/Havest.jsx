...
const Havest = (props) => {
  ...
  //check the funds which user had in the 0x40c2e3a55844Eab04590FbA0CE61E5dfBc21eAA6 contract
  //check the withdrawn funds from the 0x40c2e3a55844Eab04590FbA0CE61E5dfBc21eAA6 contract
  useEffect(() => {
    userFunds();
  }, []);
